...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation1 = new QLabel(AddressBookPage);
        labelExplanation1->setObjectName(QString::fromUtf8("labelExplanation1"));
        labelExplanation1->setTextFormat(Qt::PlainText);
        labelExplanation1->setWordWrap(true);

        verticalLayout->addWidget(labelExplanation1);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your Astato addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you.", 0, QApplication::UnicodeUTF8));
        labelExplanation1->setText(QApplication::translate("AddressBookPage", "Avoid reusing addresses!", 0, QApplication::UnicodeUTF8));
