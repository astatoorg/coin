...
//#include "miningpage.h"  //abbandoned low profit process
    ...
    rpcConsole(0)
{
    ...
    //miningPage = new MiningPage(this); //abbandoned low profit process
    ...
    //centralWidget->addWidget(miningPage); abbandoned
